 ...
 */
     ...
     */
        ...
        DateTimeFormatter DTFomat = DateTimeFormatter.ofPattern("MM/dd/yy");
        LocalDateTime time1 = LocalDateTime.of(2019,5,20,16,30);
        System.out.println(time1 );
        System.out.println(time1.format(DTFomat) );

        System.out.println(LocalDateTime.now().format(DTFomat ));
